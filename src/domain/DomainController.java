...
public class DomainController {
    ...
    /**
     * Returns amount of silver of a given player.
     * 
     * @param player
     * @return
     */
    ...
    /**
     * Add all players from the player repository to the game.
     */
    ...
    /**
     * Returns a list of the saved game names.
     * 
     * @return
     * @throws SQLException
     */
     ...
     * @return
     */
    private int[] getFortuneIdentifiers() {
