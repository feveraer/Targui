...
public class UseCase8 {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println(dc.getSavedGameNames());
        ...
        for(int teller=0; teller<players.length;teller++){
            playerNames[teller]=players[teller][0];
        }
        ...
        do {
            ...
            if (next.toLowerCase().charAt(0) == 'y' || next.isEmpty()) {
                ...
                if (dc.getCurrentTurnNumber() == dc.getNumberOfTurns()) {
                    ...
                    if (ans == 1){
                        System.out.println("Enter a name for the saved game");
                        String gameName = input.nextLine();
                        dc.saveGame(gameName);
                    }
                }
            } else {
                System.exit(0);
